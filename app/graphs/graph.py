...
from app.graphs.agent_tools import ask_user, critique_note, explore_note, finalize, respond, write_draft
...
def build_graph(checkpointer: BaseCheckpointSaver | None = None):
    ...
    builder.add_node("tools", ToolNode([ask_user, write_draft, finalize, critique_note, explore_note, respond]))

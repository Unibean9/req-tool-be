...
- Interrupt-bearing tools (`ask_user`, `respond`, `analysis_frame`, `write_draft`, `finalize`, `confirm_intent`) always run alone — the harness drops any other tool paired with them.

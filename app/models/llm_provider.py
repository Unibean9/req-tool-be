...
class LLMProviderConfig(AuditMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("(secret_ref IS NULL) != (encrypted_api_key IS NULL)", name="ck_llm_provider_secret_xor"),
    )
    ...
    provider_type: Mapped[ProviderType] = enum_column(ProviderType, nullable=False, index=True)

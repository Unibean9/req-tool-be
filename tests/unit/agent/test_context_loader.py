...
def testcontext_artifact_types_covers_same_container_and_transitive_ancestors():
    vision_objectives_types = context_artifact_types("vision_objectives")
    ...
    functional_requirement_types = context_artifact_types("functional_requirement")
